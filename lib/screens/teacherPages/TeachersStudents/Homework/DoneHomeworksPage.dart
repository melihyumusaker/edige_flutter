...
class DoneHomeworksPage extends StatelessWidget {
  const DoneHomeworksPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: TeacherStudentsHomeworksAppBar(titleText: "Yapılan Ödevler"),
      body: Container(
        ...
        child: Obx(() {
          final coursesList = teacherController.getStudentsDoneCoursesList;
